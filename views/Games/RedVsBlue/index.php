    ...
    this.back = this.position.z - this.depth / 2;
            ...
            this.velocity.y += this.gravity;
             ...
             if (boxCollision({ box1: this, box2: ground })) {
                ...
                // Restablecer el contador de saltos al tocar la plataforma
                jumpCount = 0;
             } else {
        ...
        function enviarPuntuacion(puntaje) {
            ...
            let score = updateHighScore(highScore);
...
document.addEventListener('touchstart', (event) => {
    ...
    // Divide la pantalla en zonas
    const isLeft = touchX < screenWidth / 4;
    const isRight = touchX > screenWidth * 3 / 4;
    const isTop = touchY < screenHeight / 2;
    const isBottom = touchY > screenHeight / 2;
   ...
   // Permitir saltar solo si el contador de saltos es menor que 2
   if (jumpCount < 2) {
        cube.velocity.y = 0.08;
        jumpCount++;
    }
...
function gameOver() {
    ...
    updateHighScoreIfNeeded(); // Actualiza el high score si es necesario
}
