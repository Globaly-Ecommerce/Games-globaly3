...
function Start() {
  ...
  let highScoreText = document.querySelector(".high-score-val").textContent;
  highScore = parseInt(highScoreText) || 0;
}
...
function GameOver() {
  ...
  //document.getElementById("botonReinicio").classList.remove("oculto");
