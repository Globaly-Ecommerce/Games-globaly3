...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/media/user-img/Globy.png">
            ...
            <div class="container-fluid">
                <div class="login-block">
                    <div class="login-content">
                        <h1 class="color-white mb-32">Iniciar Sesión</h1>
                        <div class="login-sec hide-form">
                            <form action="login.php" method="post">
                                <div class="mb-32">
                                    <input type="email" name="email" class="form-control mb-32"
                                        placeholder="Correo Electrónico" required>
                                </div>
                                <div class="mb-32">
                                    <input type="password" name="clave" class="form-control mb-32"
                        ...
                        <div class="text-center">
                            <h6>Crear una Cuenta? <a href="<?php echo $baseUrl; ?>signup.php" class="color-primary">Registrarse</a></h6>
